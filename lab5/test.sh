...
clear
./simulate ucode5 assembly/pagetable.out assembly/add.out assembly/data.out assembly/except_page.out assembly/except_prot.out assembly/except_unalgined.out assembly/except_unknown.out assembly/int.out assembly/vector_table.out